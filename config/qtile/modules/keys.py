...
keys = [
    ...
    Key([],"XF86MonBrightnessDown", lazy.spawn(
        """sh /home/Arlz/.config/qtile/scripts/brighMin.sh"""
    ),desc="Uo brightnes"),

    Key([], "XF86MonBrightnessUp",  lazy.spawn(
        """sh /home/Arlz/.config/qtile/scripts/brighSup.sh"""
    ),desc="Down brightnes"),
    ...
    Key([mod],"t" ,lazy.spawn(
        """sh /home/Arlz/.config/qtile/scripts/ShowInfo.sh"""
        ), desc= "Show Temperature"
        ),

    Key([], "XF86AudioRaiseVolume",lazy.spawn(
    """sh /home/Arlz/.config/qtile/scripts/AudioSup.sh"""
    ),desc="Up Volumen"),

    Key([], "XF86AudioLowerVolume",lazy.spawn(
    """sh /home/Arlz/.config/qtile/scripts/AudioMin.sh"""
        ),desc="Up Volumen"),
    Key([mod, "shift"], "s", lazy.spawn("scrot -s /home/Arlz/Pictures/Screens/Screen.png"), desc = "Screen"),
