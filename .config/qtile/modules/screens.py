...
screens = [
    Screen(
        wallpaper= '/home/noneda/Pictures/Space_aesthetic_moodboard_space_galaxy_wallpaper_planet.jpeg',
        wallpaper_mode='fill',
        # bottom=bar.Bar(
        top=bar.Bar(
        [
            ...
            widget.Systray( 
                background = "#00000000", padding = 7, icon_size = 16
            ),
            ...
            widget.Wlan(
                background = colors[4], format = '  ', interface =  'wlan0',
